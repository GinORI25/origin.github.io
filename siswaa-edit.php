...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="title  link-light">
            <center><h1>UPDATE DATA SISWA</h1></center>
        </div>
        <div class="row">
            ...
            <div class="col-sm-5 col-md-4 col-lg-8">
                <div class="card" style="background: rgba(0,0,0,0.3);">
                    ...
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            $siswaa_id = mysqli_real_escape_string($con, $_GET['id']);
                            $query = "SELECT * FROM employees WHERE id='$siswaa_id' ";
                            $query_run = mysqli_query($con, $query);

                            if(mysqli_num_rows($query_run) > 0)
                            {
                                $siswaa = mysqli_fetch_array($query_run);
                                ?>
                                <form action="code.php" method="POST">
                                    <input type="hidden" name="siswaa_id" value="<?=$siswaa['id']; ?>">
                                    ...
                                    <path d="M2 1a1 1 0 0 0-1 1v4.586a1 1 0 0 0 .293.707l7 7a1 1 0 0 0 1.414 0l4.586-4.586a1 1 0 0 0 0-1.414l-7-7A1 1 0 0 0 6.586 1H2zm4 3.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/>
                                        ...
                                        <input type="text" name="name" value="<?=$siswaa['name'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3 link-light">
                                        ...
                                        <input type="email" name="email" value="<?=$siswaa['email'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3 link-light">
                                    ...
                                    <input type="text" name="phone" value="<?=$siswaa['phone'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3 link-light">
                                ...
                                <select  name="kelamin" class="form-control" value="<?=$siswaa['kelamin'];?>">
                                    ...
                                    <div class="mb-3 link-light">
                                        ...
                                        <input type="text" name="Hobi" value="<?=$siswaa['Hobi'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <button type="submit" name="update_siswaa" class="btn btn-primary">
                                            Update data
                                        </button>
                                    </div>
                            </div>
